...
public class ComplaintServiceImp  implements IComplaintService{
    ...
    public Complaint addComplaint(Complaint complaint) {
        // Check for null values in title and description, and censor bad words if present
        if (complaint.getTitle() != null) {
            complaint.setTitle(badWordsFilterService.censorBadWords(complaint.getTitle()));
        } else {
            complaint.setTitle(""); // or some default title if necessary
        }

        if (complaint.getDescription() != null) {
            complaint.setDescription(badWordsFilterService.censorBadWords(complaint.getDescription()));
        } else {
            complaint.setDescription(""); // or some default description if necessary
        }

        //complaint.setTitle(badWordsFilterService.censorBadWords(complaint.getTitle()));
        //complaint.setDescription(badWordsFilterService.censorBadWords(complaint.getTitle()));
        // Set default values
